...
public class EmailService {
    ...
    // private String verifyURL = "http://localhost:8080/user/verify?code="; Desenvolvimento
    private String verifyURL = "https://devstore-l8vj.onrender.com/user/verify?code=";
