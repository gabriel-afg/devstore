    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/pix/key").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/pix/charges").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/pix/charges/{txid}").permitAll()
